...
LRESULT Window::HandleMsg(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam) noexcept
{
	switch (msg)
	{
	//return 0 for my class to destroy window not proc defWindowProc to destroy window
	case WM_CLOSE:
		PostQuitMessage(0);
		return 0;
...
//******* MOUSE MSGS **********************************************/
	case WM_MOUSEMOVE:
	{
		...
		// not in client -> log move / mantain capture if button is down
		else
		{
